...
def fusion_counts(counts: List[dict], positions: List[int]) -> dict:
    """
    Fusions the a list of dictionnary counts into one with the combined bitsrings. The combined result bitstrings will be
    generated by their given positions.

    Parameters:
    - counts List[dict]): The list of counts reulted by the runs of the QMIS on subgraphes.
    - positions (List[int]): The subgraph index containinhg the ith node.

    Returns:
    dict: The combined counts dictionnary of the subgraphes.
    """
    total_counts = {}
