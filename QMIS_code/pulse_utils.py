...
def Pulse_constructor(
    ...
    """
    assert Pulse_type in ['Waveform', 'Blackman', 'Rise_fall', 'Pyramid', 'Rise_sweep_fall'], "The five types implemented are 'Waveform', 'Blackman', 'Rise_fall', 'Pyramid', and 'Rise_sweep_fall', please use one of them."
