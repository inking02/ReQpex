...
new_bins_location = pd.read_csv(
    "/Users/lf/Documents/GitHub/ReQpex/datasets/nouvelles_cloches.csv", sep=","
)
new_bins_location_numpy = new_bins_location[["Longitude", "Latitude"]].to_numpy(
    dtype=float, copy=True
)
bins_og_used = pd.read_csv(
...
og_bins = pd.read_csv("/Users/lf/Documents/GitHub/ReQpex/datasets/cloches.csv", sep=";")
...
def show_map(show_estrie_aide: bool = False):
...
show_map(show_estrie_aide=True)
