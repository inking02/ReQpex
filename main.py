...
def main(
    ...
    """
    Runs the algorithm to solve Recupex bins placement optimization problem. The dataset of the new bons will be saved in the new_bins.csv file
    ...
    - use_quantum (bool = True): Whether or not to use the QAA method to find the mis. If not, the networkx's MIS function
                                 will be used.
