...
def generate_map(points, title: str = ""):
    ...
    sherbrooke = gpd.read_file(
        "/Users/lf/Desktop/Université/Session 3/BSQ201/Projet 2/datasets/Arrondissements/Arrondissements.shp"
    )
    ...
    plt.legend()
    plt.savefig("datasets/carte.png")


# Lecture du fichier
points = pd.read_csv(
    "/Users/lf/Desktop/Université/Session 3/BSQ201/Projet 2/datasets/adresse_sherbrooke_ll.csv"
)
