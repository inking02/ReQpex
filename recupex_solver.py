...
def simplify_bins(
    ...
    def disc_graph_to_connected_volume(
        ...
        Parameters:
        - positions (NDArray[np.float_]): The array of the points of the nodes of the graph.
        - radius (float): The radius of which if two circles generated by the points touch, they have an edge.

        Returns:
        netwrokx.graph: The networkx graph that represents the positions and its radius.
        """
        G = nx.Graph()
